...
#   ------------------------------------------------------------
    ...
    export PATH="/Users/boo/bin:/usr/local/git/bin:/sw/bin:/usr/local/bin:/usr/local:/usr/local/sbin:/usr/local/mysql/bin:$PATH"
...
alias o='open .'							# Opens current dirctory
...
alias ep='edit ~/.profile'					# Edit this file
alias ~="cd ~"                              # ~:            Go Home
...
#python - change to 'python3' when ready
py () {
	python "$@"
}
